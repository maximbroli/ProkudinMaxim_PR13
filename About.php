<html dir="ltr" lang="en-US" style="--cnvs-viewport-width: 1409; --cnvs-viewport-height: 939; --cnvs-body-height: 3002;"><head>
...
<body class="stretched device-xxl device-up-xxl device-up-xl device-up-lg device-up-md device-up-sm device-up-xs is-expanded-menu has-plugin-animations has-plugin-hoveranimation has-plugin-twitter has-plugin-instagram has-plugin-onepage has-plugin-bootstrap has-plugin-lightbox has-plugin-isotope has-plugin-flexslider has-plugin-counter has-plugin-progress has-plugin-masonrythumbs has-plugin-form has-plugin-scrolldetect">
	...
	<div id="wrapper">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header dark" data-sticky-class="not-dark" data-bs-theme="dark">
			<div id="header-wrap" class="">
				<div class="container">
					<div class="header-row top-search-parent">
						...
						<form class="top-search-form" action="search.html" method="get" style="width: 1334px;">
		...
		<!-- Page Title
		============================================= -->
		<section class="page-title page-title-parallax parallax scroll-detect dark page-title-right include-header scroll-detect-inview" style="padding: 250px 0px; --cnvs-scroll-height: 693; --cnvs-scroll-percent: 57.53676470588235; --cnvs-scroll-ratio: 1; --cnvs-scroll-start: 1; --cnvs-scroll-end: 0; margin-top: -101px;" data-bs-theme="dark">
			<img src="images/about/me-parallax.jpg" class="parallax-bg">
			<div class="container">
				<div class="page-title-row">

					<div class="page-title-content">
						<h1>Maxim Prokudin</h1>
						...
						<div class="col-lg-6 col-md-6">
							...
							<div class="skill-progress" data-percent="80" data-speed="1000" style="--cnvs-progress-height: 0.25rem;">
								...
								<div class="skill-progress-bar">
									<div class="skill-progress-percent bg-color" style="--cnvs-progress-speed: 1000ms;"></div>
								</div>
							</div>
							...
							<div class="skill-progress" data-percent="60" data-speed="1000" style="--cnvs-progress-height: 0.25rem;">
								<div class="skill-progress-title mb-2">
									<h5>CSS3</h5>
									<div class="badge bg-light text-dark">
										<div class="counter counter-inherit counter-instant"><span data-from="0" data-to="60" data-refresh-interval="30" data-speed="1000">60</span>%</div>
									</div>
								</div>
								<div class="skill-progress-bar">
									<div class="skill-progress-percent bg-color" style="--cnvs-progress-speed: 1000ms;"></div>

<html dir="ltr" lang="en-US" style="--cnvs-viewport-width: 1565; --cnvs-viewport-height: 939; --cnvs-body-height: 2440;"><head>
...
<body class="stretched device-up-xl device-up-lg device-up-md device-up-sm device-up-xs is-expanded-menu has-plugin-animations has-plugin-html5video has-plugin-onepage has-plugin-bootstrap has-plugin-swiper has-plugin-counter has-plugin-carousel has-plugin-form device-xxl device-up-xxl">
	...
	<div id="wrapper">
			...
			<div id="header-wrap" class="">
				<div class="container">
					<div class="header-row top-search-parent">
						...
						<form class="top-search-form" action="search.html" method="get" style="width: 1490px;">
		...
		<section id="slider" class="slider-element revslider-wrap slider-parallax min-vh-100 include-header slider-parallax-visible" style="margin-top: -101px;">
    <div class="slider-inner" style="transform: translate3d(0px, 0px, 0px); height: 100vh;">
        <div class="forcefullwidth_wrapper_tp_banner" id="rev_slider_579_1_forcefullwidth" style="position:relative;width:100%;height:100%;margin-top:0px;margin-bottom:0px">
            <div id="rev_slider_579_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="default-slider" style="padding: 0px; margin-top: 0px; margin-bottom: 0px; position: absolute; max-height: none; overflow: visible; height: 100%; width: 100%; left: 0px;">
                <!-- START REVOLUTION SLIDER 5.1.4 fullscreen mode -->
                <div id="rev_slider_579_1" class="rev_slider fullscreenbanner revslider-initialised tp-simpleresponsive rev_redraw_on_blurfocus" style="max-height: 100%; margin-top: 0px; margin-bottom: 0px; height: 100%;" data-version="5.1.4" data-slideactive="rs-344741">
                    <ul class="tp-revslider-mainul" style="visibility: visible; display: block; overflow: hidden; width: 100%; height: 100%; max-height: none;">
                        <!-- SLIDE  -->
                        <!-- MAIN IMAGE -->
                        <li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-thumb="images/slider/rev/main/s3-thumb.jpg" data-delay="10000" data-saveperformance="off" data-title="Responsive &amp; Retina" class="tp-revslider-slidesli active-revslide" style="width: 100%; height: 100%; overflow: hidden; z-index: 20; visibility: inherit; opacity: 1; background-color: rgba(255, 255, 255, 0);">
                            <!-- MAIN IMAGE -->
                            <div class="slotholder" style="position: absolute; top: 0px; left: 0px; z-index: 0; width: 100%; height: 100%; visibility: inherit; opacity: 1;">
                                <div class="tp-bgimg defaultimg" data-bgcolor="black" style="background-repeat: no-repeat; background-image: url('images/slider/rev/main/s3.jpg'); background-size: cover; background-position: center; width: 100%; height: 100%; opacity: 1; visibility: inherit; z-index: 20;" src="images/slider/rev/main/s3.jpg"></div>
                                <div class="tp-kbimg-wrap" style="z-index: 2; width: 100%; height: 100%; top: 0px; left: 0px; position: absolute; transform: translate3d(0px, 0px, 0px); transform-origin: 0% 0% 0px;">
                                    <img class="tp-kbimg" src="images/slider/rev/main/s3.jpg" style="position: absolute; width: 100%; height: 100%; object-fit: cover; transform: translate3d(0px, 0px, 0px); transform-origin: 0% 0% 0px;" width="2613" height="1737">
                                </div>
                            </div>
                            <!-- LAYERS -->
                                    ...
                                    <div class="fslider" data-animation="fade">
                                        <div class="flexslider" style="height: auto;">
                                                    ...
                                                    <a href="#" class="d-block position-relative">
                                                        ...
                                                        <div class="bg-overlay">
                                                            <div class="bg-overlay-content">
                                                                <div class="h3 fw-light py-2 px-3 bg-color text-light rounded">Wallpapers</div>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                                            ...
                                            <ul class="flex-direction-nav">
                                                <li class="flex-nav-prev"><a class="flex-prev" href="#"><i class="uil uil-angle-left-b"></i></a></li>
                                                <li class="flex-nav-next"><a class="flex-next" href="#"><i class="uil uil-angle-right-b"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
